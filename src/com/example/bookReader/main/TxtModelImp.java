...
import com.example.bookReader.pipeline.TxtPipeline;
import com.example.bookReader.pipeline.TxtPipelineImp;
import com.example.bookReader.utils.BitmapUtil;
import com.example.bookReader.utils.FileCharsetDetector;
...
public class TxtModelImp implements TxtModel {
	...
	private void refrespageBitmap() {
		...
		bitmapCache.setPagebitmap(com.example.bookReader.utils.BitmapUtil.CreateBitmapWitThisBg(context.getResources(),
